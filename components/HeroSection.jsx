...
export function HeroSectionOne() {
  return (
    <div
      className="relative   flex max-w-full flex-col items-center justify-center">
      <Navbar />
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        <motion.p
          ...
          Practice real-time, role-specific mock interviews with intelligent feedback, ratings, and ideal answers — all powered by GenAI. Build confidence, improve performance, and get interview-ready.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
          ...
          <Link href='/dashboard'>
          <button
            className="w-60 transform rounded-lg bg-black px-6 py-2 cursor-pointer font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200">
            Explore Now
          </button>
          </Link>
          <button
            className="w-60 transform rounded-lg border border-gray-300 bg-white cursor-pointer px-6 py-2 font-medium text-black transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-100 dark:border-gray-700 dark:bg-black dark:text-white dark:hover:bg-gray-900">
            Contact Support
          </button>
        </motion.div>
        <motion.div
...
const Navbar = () => {
  return (
    <nav
      ...
      <Link href='/dashboard'>
      <button
        className="w-24 transform rounded-lg bg-black px-6 py-2 cursor-pointer font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 md:w-32 dark:bg-white dark:text-black dark:hover:bg-gray-200">
        Login
      </button>
      </Link>
    </nav>
